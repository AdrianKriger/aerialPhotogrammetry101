...
PRESET = {'SEQUENTIAL': [0, 1, 2, 3, 9, 10, 11, 12, 13],
          ...
          'MVG_GLOBAL': [0, 1, 2, 4, 5, 6, 7],
          'MVS_SGM': [14, 15],
          'SEQ_geo': [0, 1, 3, 4, 6, 9, 11, 12], # 13, 14, 15],
          }
    ...
    def __init__(self):
        self.steps_data = [
            ...
            ["Compute features",             # 1
             ...
             ["-i", "%matches_dir%\sfm_data.json", "-o", "%matches_dir%", "-m", "SIFT", "-n", "4"]], # "-f", "1"
            ...
            ["Compute matches",              # 3
             ...
             #["-i", "%matches_dir%\sfm_data.json", "-l", "%matches_dir%\pair_list.txt", "-o", "%matches_dir%", "-n", "ANNL2", "-r", ".8"]],
            ...
            ["Densify point cloud",          # 12
             ...
             ["-i", "sceneGeo.mvs", "-o", "sceneGeo_dense.mvs", "--dense-config-file", "Densify.ini", "--resolution-level", "1", "--number-views", "5", "--max-threads", "4", "-w", "%mvs_dir%"]],
...
if 15 in CONF.steps:                                # Split scene
    path = CONF.mvs_dir
